...
if lab_numbers == "01 - One risky and one risk-free asset":
    ...
    st.image(image_return, width=400)
    ...
    if solution:
        st.success(f'You have selected {dictionary_symbols[symbol_forecast]} stock.Standard Deviation of the stock returns is of {np.round(asset_std_dev,4)}')
